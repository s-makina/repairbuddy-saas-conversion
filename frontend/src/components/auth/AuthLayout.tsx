...
export function AuthLayout({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[var(--rb-surface-muted)] text-[var(--rb-text)]">
      <div
        className={cn(
          "pointer-events-none absolute inset-0 -z-10",
          "bg-[radial-gradient(ellipse_at_top,rgba(6,62,112,0.16),transparent_55%),radial-gradient(ellipse_at_bottom,rgba(253,103,66,0.12),transparent_55%)]",
        )}
      />

      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl items-stretch gap-10 px-4 py-10 lg:px-8">
        <aside className="hidden w-[360px] flex-col justify-between lg:flex">
          <div className="rounded-[var(--rb-radius-xl)] bg-[var(--rb-blue)] p-8 shadow-[var(--rb-shadow)]">
      ...
      <div className="pointer-events-none absolute inset-x-0 bottom-0 -z-10 h-64 bg-[linear-gradient(to_top,rgba(6,62,112,0.18),transparent)]" />
      <div className="pointer-events-none absolute inset-y-0 left-0 -z-10 w-[420px] bg-[linear-gradient(to_right,rgba(6,62,112,0.72),rgba(6,62,112,0.55),transparent)]" />
    </div>
  );
}
