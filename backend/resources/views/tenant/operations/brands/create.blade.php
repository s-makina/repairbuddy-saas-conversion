		...
		<div class="row justify-content-center g-10">
			<div class="col-12 col-lg-7 col-xl-8">
				<div class="card">
					...
					<div class="card-body">
						<form method="post" action="{{ route('tenant.operations.brands.store', ['business' => $tenant->slug]) }}" enctype="multipart/form-data">
							@csrf
							<div class="row g-3">
								<div class="col-12">
			...
			<div class="col-12 col-lg-5 col-xl-4">
				<div class="card">
					<div class="card-header">
						<h5 class="card-title mb-0">{{ __('Recent brands') }}</h5>
					</div>
					<div class="card-body p-0">
						<div class="list-group list-group-flush">
							@forelse (($recentBrands ?? []) as $b)
								@php
									$editUrl = route('tenant.operations.brands.edit', ['business' => $tenant->slug, 'brand' => $b->id]);
								@endphp
							...
							@empty
								<div class="list-group-item">
									<div class="text-muted">{{ __('No brands yet.') }}</div>
								</div>
							@endforelse
						</div>
					</div>
