	...
	<div class="wrap">
		...
		<form data-abide class="needs-validation" novalidate method="post" action="{{ route('tenant.settings.reviews.update', ['business' => $tenant->slug]) }}">
			...
			<div class="wcrb-settings-form">
				<x-settings.card :title="__('Job Reviews')">
					<div class="row g-3">
						<div class="col-12">
							<x-settings.option-toggle
								...
								value="on"
								uncheckedValue="off"
								:label="__('Request Feedback by SMS')"
								:description="__('Enable SMS notification for feedback request')"
								style="border-bottom: 0; padding-bottom: 6px; margin-bottom: 6px;"
							/>
						</div>
						...
						<div class="col-12">
							<x-settings.option-toggle
								...
								value="on"
								uncheckedValue="off"
								:label="__('Request Feedback by Email')"
								:description="__('Enable Email notification for feedback request')"
								style="border-bottom: 0; padding-bottom: 6px; margin-bottom: 6px;"
							/>
						</div>
