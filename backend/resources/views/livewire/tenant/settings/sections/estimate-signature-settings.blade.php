{{-- Estimate Signature Workflow Settings Section — Livewire Component --}}
<div>
    <form wire:submit.prevent="save">
        ...
        <div class="st-section" x-data="{ open: true }">
            <div class="st-section-header" @click="open = !open">
                <h3 class="st-section-title">
                    <svg class="st-sec-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    Approval Signature
                </h3>
            ...
            <div class="st-section-body" x-show="open" x-collapse>
                <div class="st-option-card">
                    <div class="st-option-control">
                        <label class="st-toggle">
                            <input type="checkbox" wire:model.defer="approval_enabled" />
                            <span class="st-toggle-track"></span>
                        </label>
                    </div>
                    <div class="st-option-body">
                        <label class="st-option-title">Enable Approval Signature</label>
                        <p class="st-option-desc">Require customer signature to approve the estimate</p>
                    </div>
                </div>

                <div class="st-grid st-grid-2" style="margin-top: .75rem;">
                    <div class="st-fg">
                        <label for="approval_trigger_status">Trigger on Status</label>
                        <select id="approval_trigger_status" wire:model.defer="approval_trigger_status">
                            @foreach ($statusOptions as $val => $label)
                                <option value="{{ $val }}">{{ $label }}</option>
                            @endforeach
                        </select>
                        <p class="st-help">Estimate status that triggers the approval signature request</p>
                    </div>
                    <div class="st-fg">
                        <label for="approval_after_status">Status After Submission</label>
                        <select id="approval_after_status" wire:model.defer="approval_after_status">
                            @foreach ($statusOptions as $val => $label)
                                <option value="{{ $val }}">{{ $label }}</option>
                            @endforeach
                        </select>
                ...
                <div class="st-fg">
                    <label for="approval_email_subject">Email Subject</label>
                    <input type="text" id="approval_email_subject" wire:model.defer="approval_email_subject"
                           placeholder="Please sign to approve your estimate" />
                </div>

                <div class="st-fg">
                    <label for="approval_email_template">Email Template</label>
                    <textarea id="approval_email_template" wire:model.defer="approval_email_template" rows="4"
                              placeholder="Email body sent when approval signature is requested..."></textarea>
                    <p class="st-help">Keywords: @{{approval_signature_url}}, @{{estimate_id}}, @{{case_number}}, @{{customer_full_name}}, @{{estimate_total}}, @{{estimate_items}}</p>
                </div>

                <div class="st-fg">
                    <label for="approval_sms_text">SMS Text</label>
                    <textarea id="approval_sms_text" wire:model.defer="approval_sms_text" rows="3"
                              placeholder="SMS message for approval signature request..."></textarea>
            ...
            <div class="st-section-body" x-show="open" x-collapse>
                <div class="st-option-card">
                    ...
                    <div class="st-option-body">
                        ...
                        <p class="st-option-desc">Require customer signature when picking up their device after estimate approval</p>
                    </div>
                </div>
                ...
                <div class="st-grid st-grid-2" style="margin-top: .75rem;">
                    <div class="st-fg">
                        ...
                        <p class="st-help">Estimate status that triggers the pickup signature request</p>
                    </div>
                    <div class="st-fg">
                ...
                <div class="st-fg">
                    ...
                    <p class="st-help">Keywords: @{{pickup_signature_url}}, @{{estimate_id}}, @{{case_number}}, @{{customer_full_name}}, @{{estimate_items}}</p>
                </div>
            ...
            <div class="st-section-body" x-show="open" x-collapse>
                <div class="st-option-card">
                    ...
                    <div class="st-option-body">
                        ...
                        <p class="st-option-desc">Require customer signature when delivering their device after estimate approval</p>
                    </div>
                </div>
                ...
                <div class="st-grid st-grid-2" style="margin-top: .75rem;">
                    <div class="st-fg">
                        ...
                        <p class="st-help">Estimate status that triggers the delivery signature request</p>
                    </div>
                    <div class="st-fg">
                ...
                <div class="st-fg">
                    ...
                    <p class="st-help">Keywords: @{{delivery_signature_url}}, @{{estimate_id}}, @{{case_number}}, @{{customer_full_name}}, @{{estimate_items}}</p>
                </div>
        ...
        <div class="st-save-bar">
            <button type="submit" class="st-btn-save" wire:loading.attr="disabled">
                <span wire:loading.remove wire:target="save">Save Estimate Signature Settings</span>
