...
class TenantDashboardController extends Controller
{
    public function show(Request $request)
    {
        ...
        if ($screen === 'calendar') {
            // Redirect to standalone calendar route
            return redirect()->route('tenant.calendar', ['business' => $tenant->slug]);
        }
...
HTML;
        ...
        $calendar_url = route('tenant.calendar', ['business' => $tenant->slug]);
