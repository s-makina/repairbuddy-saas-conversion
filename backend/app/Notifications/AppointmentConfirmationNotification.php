...
class AppointmentConfirmationNotification extends Notification
{
    ...
    {
        $subject = $this->customSubject ?? __('Appointment Confirmation');
        ...
        return (new MailMessage)
            ...
            ->line(__('Your appointment has been scheduled.'))
            ->line('')
            ...
            ->line('')
            ->line(__('Thank you for choosing :business!', ['business' => $businessName]));
    }
