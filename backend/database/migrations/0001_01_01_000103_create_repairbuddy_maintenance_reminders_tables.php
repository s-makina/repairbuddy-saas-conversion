...
return new class extends Migration
{
    ...
    {
        if (! Schema::hasTable('rb_maintenance_reminders')) {
            Schema::create('rb_maintenance_reminders', function (Blueprint $table) {
                ...
                $table->index(['tenant_id', 'branch_id', 'reminder_enabled'], 'rb_mr_tenant_branch_enabled_idx');
                $table->index(['tenant_id', 'branch_id', 'updated_at'], 'rb_mr_tenant_branch_updated_idx');
            });
        } else {
            Schema::table('rb_maintenance_reminders', function (Blueprint $table) {
                try {
                    $table->index(['tenant_id', 'branch_id', 'reminder_enabled'], 'rb_mr_tenant_branch_enabled_idx');
        ...
        if (! Schema::hasTable('rb_maintenance_reminder_logs')) {
            Schema::create('rb_maintenance_reminder_logs', function (Blueprint $table) {
                ...
                $table->index(['tenant_id', 'branch_id', 'reminder_id', 'created_at'], 'rb_mr_logs_tenant_rem_created_idx');
                $table->index(['tenant_id', 'branch_id', 'job_id', 'created_at'], 'rb_mr_logs_tenant_job_created_idx');
            });
        } else {
            Schema::table('rb_maintenance_reminder_logs', function (Blueprint $table) {
                try {
                    $table->index(['tenant_id', 'branch_id', 'reminder_id', 'created_at'], 'rb_mr_logs_tenant_rem_created_idx');
                } catch (QueryException) {
                    // ignore
        ...
        if (! Schema::hasTable('rb_job_maintenance_reminder_state')) {
